        ...
        else
        {
             ...
             while($row=mysqli_fetch_assoc($q)) //to fetch all rows from table
             {
               echo "<tr>";
                  ...
                  echo"<td>"; ?> <a href="update.php?book_id=<?php echo $row['bid'];?>" ><i class="fas fa-edit" aria-hidden="true"></i></a><?php echo"</td>";
                  echo"<td>"; ?> <a href="delete.php?bk_id=<?php echo $row['bid'];?>" ><i class="fas fa-trash" aria-hidden="true"></i></a>
                  <?php echo "</td>";
               echo "</tr>";
             }
